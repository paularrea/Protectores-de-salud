...
const DetalleCitaDayTwo = () => {
  ...
  const { id } = useParams();
  const interventions = contextUser && contextUser.agenda.day_1.list_of_events;
  ...
  useEffect(() => {
    const interventions =
      contextUser && contextUser.agenda.day_1.list_of_events;
    const currentAppointment =
      interventions &&
    ...
    setPatientDate(contextUser && contextUser.agenda.day_1.date_as_text);
  }, [contextUser, id]);
