...
const DetalleCitaDayFive = () => {
  ...
  const { id } = useParams();
  const interventions = contextUser && contextUser.agenda.day_4.list_of_events;
  ...
  useEffect(() => {
    const interventions =
      contextUser && contextUser.agenda.day_4.list_of_events;
    const currentAppointment =
      interventions &&
    ...
    setPatientDate(contextUser && contextUser.agenda.day_4.date_as_text);
  }, [contextUser, id]);
